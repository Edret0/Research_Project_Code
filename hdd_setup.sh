...
fio --name=latency-test --ioengine=sync --rw=randwrite --size=20G --bs=4k --numjobs=4 --runtime=60s --time_based --latency=50ms --output=fio_latency_results_sda.log --filename=/dev/sda
fio --name=latency-test --ioengine=sync --rw=randwrite --size=20G --bs=4k --numjobs=4 --runtime=60s --time_based --latency=50ms --output=fio_latency_results_sdb.log --filename=/dev/sdb
fio --name=latency-test --ioengine=sync --rw=randwrite --size=20G --bs=4k --numjobs=4 --runtime=60s --time_based --latency=50ms --output=fio_latency_results_sdc.log --filename=/dev/sdc
